...
export function generateDemoStudents(count: number = 100): DemoStudent[] {
  ...
  const hardcodedStudents: DemoStudent[] = [
    ...
    { id: 'demo-s9', firstName: 'Miguel', lastName: 'Torres', email: 'estudiante9@demo.com', enrolledAt: new Date(baseDate.getTime() - 48 * 24 * 60 * 60 * 1000).toISOString(), className: 'Programación Web Moderna', lastLoginAt: new Date(baseDate.getTime() - 6 * 60 * 60 * 1000).toISOString() },
    ...
    { id: 'demo-s11', firstName: 'Pedro', lastName: 'García', email: 'estudiante11@demo.com', enrolledAt: new Date(baseDate.getTime() - 44 * 24 * 60 * 60 * 1000).toISOString(), className: 'Programación Web Moderna', lastLoginAt: new Date(baseDate.getTime() - 4 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s12', firstName: 'Sofía', lastName: 'Rodríguez', email: 'estudiante12@demo.com', enrolledAt: new Date(baseDate.getTime() - 38 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico Profesional', lastLoginAt: new Date(baseDate.getTime() - 20 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s13', firstName: 'Diego', lastName: 'Martínez', email: 'estudiante13@demo.com', enrolledAt: new Date(baseDate.getTime() - 58 * 24 * 60 * 60 * 1000).toISOString(), className: 'Programación Web Moderna', lastLoginAt: new Date(baseDate.getTime() - 7 * 60 * 60 * 1000).toISOString() },
    ...
    { id: 'demo-s15', firstName: 'Javier', lastName: 'Sánchez', email: 'estudiante15@demo.com', enrolledAt: new Date(baseDate.getTime() - 42 * 24 * 60 * 60 * 1000).toISOString(), className: 'Programación Web Moderna', lastLoginAt: new Date(baseDate.getTime() - 11 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s16', firstName: 'Juan', lastName: 'Pérez', email: 'estudiante16@demo.com', enrolledAt: new Date(baseDate.getTime() - 56 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico Profesional', lastLoginAt: new Date(baseDate.getTime() - 16 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s17', firstName: 'María', lastName: 'Gómez', email: 'estudiante17@demo.com', enrolledAt: new Date(baseDate.getTime() - 68 * 24 * 60 * 60 * 1000).toISOString(), className: 'Programación Web Moderna', lastLoginAt: new Date(baseDate.getTime() - 13 * 60 * 60 * 1000).toISOString() },
    ...
    { id: 'demo-s19', firstName: 'Ana', lastName: 'Torres', email: 'estudiante19@demo.com', enrolledAt: new Date(baseDate.getTime() - 46 * 24 * 60 * 60 * 1000).toISOString(), className: 'Programación Web Moderna', lastLoginAt: new Date(baseDate.getTime() - 14 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s20', firstName: 'Luis', lastName: 'Díaz', email: 'estudiante20@demo.com', enrolledAt: new Date(baseDate.getTime() - 64 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico Profesional', lastLoginAt: new Date(baseDate.getTime() - 19 * 60 * 60 * 1000).toISOString() },
    ...
    { id: 'demo-s100', firstName: 'Isabel', lastName: 'Díaz', email: 'estudiante100@demo.com', enrolledAt: new Date(baseDate.getTime() - 68 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico Profesional', lastLoginAt: null },
    // Extra Diseño Gráfico Profesional students - 30 more
    { id: 'demo-s101', firstName: 'Antonio', lastName: 'García', email: 'estudiante101@demo.com', enrolledAt: new Date(baseDate.getTime() - 45 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico Profesional', lastLoginAt: new Date(baseDate.getTime() - 5 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s102', firstName: 'Beatriz', lastName: 'Rodríguez', email: 'estudiante102@demo.com', enrolledAt: new Date(baseDate.getTime() - 50 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico Profesional', lastLoginAt: new Date(baseDate.getTime() - 7 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s103', firstName: 'Cristina', lastName: 'Martínez', email: 'estudiante103@demo.com', enrolledAt: new Date(baseDate.getTime() - 55 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico Profesional', lastLoginAt: new Date(baseDate.getTime() - 11 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s104', firstName: 'Daniel', lastName: 'López', email: 'estudiante104@demo.com', enrolledAt: new Date(baseDate.getTime() - 60 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico Profesional', lastLoginAt: new Date(baseDate.getTime() - 14 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s105', firstName: 'Eva', lastName: 'Sánchez', email: 'estudiante105@demo.com', enrolledAt: new Date(baseDate.getTime() - 65 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico Profesional', lastLoginAt: new Date(baseDate.getTime() - 18 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s106', firstName: 'Fernando', lastName: 'Pérez', email: 'estudiante106@demo.com', enrolledAt: new Date(baseDate.getTime() - 42 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico Profesional', lastLoginAt: new Date(baseDate.getTime() - 9 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s107', firstName: 'Gloria', lastName: 'Gómez', email: 'estudiante107@demo.com', enrolledAt: new Date(baseDate.getTime() - 47 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico Profesional', lastLoginAt: new Date(baseDate.getTime() - 22 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s108', firstName: 'Héctor', lastName: 'Fernández', email: 'estudiante108@demo.com', enrolledAt: new Date(baseDate.getTime() - 52 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico Profesional', lastLoginAt: new Date(baseDate.getTime() - 12 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s109', firstName: 'Irene', lastName: 'Torres', email: 'estudiante109@demo.com', enrolledAt: new Date(baseDate.getTime() - 57 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico Profesional', lastLoginAt: new Date(baseDate.getTime() - 3 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s110', firstName: 'Jorge', lastName: 'Díaz', email: 'estudiante110@demo.com', enrolledAt: new Date(baseDate.getTime() - 62 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico Profesional', lastLoginAt: new Date(baseDate.getTime() - 4 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s111', firstName: 'Karina', lastName: 'García', email: 'estudiante111@demo.com', enrolledAt: new Date(baseDate.getTime() - 67 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico Profesional', lastLoginAt: new Date(baseDate.getTime() - 2 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s112', firstName: 'Luis', lastName: 'Rodríguez', email: 'estudiante112@demo.com', enrolledAt: new Date(baseDate.getTime() - 72 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico Profesional', lastLoginAt: new Date(baseDate.getTime() - 5 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s113', firstName: 'Marta', lastName: 'Martínez', email: 'estudiante113@demo.com', enrolledAt: new Date(baseDate.getTime() - 49 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico Profesional', lastLoginAt: new Date(baseDate.getTime() - 1 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s114', firstName: 'Natalia', lastName: 'López', email: 'estudiante114@demo.com', enrolledAt: new Date(baseDate.getTime() - 54 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico Profesional', lastLoginAt: new Date(baseDate.getTime() - 3 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s115', firstName: 'Oscar', lastName: 'Sánchez', email: 'estudiante115@demo.com', enrolledAt: new Date(baseDate.getTime() - 59 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico Profesional', lastLoginAt: new Date(baseDate.getTime() - 6 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s116', firstName: 'Patricia', lastName: 'Pérez', email: 'estudiante116@demo.com', enrolledAt: new Date(baseDate.getTime() - 64 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico Profesional', lastLoginAt: new Date(baseDate.getTime() - 4 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s117', firstName: 'Quique', lastName: 'Gómez', email: 'estudiante117@demo.com', enrolledAt: new Date(baseDate.getTime() - 69 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico Profesional', lastLoginAt: new Date(baseDate.getTime() - 7 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s118', firstName: 'Raúl', lastName: 'Fernández', email: 'estudiante118@demo.com', enrolledAt: new Date(baseDate.getTime() - 74 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico Profesional', lastLoginAt: new Date(baseDate.getTime() - 2 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s119', firstName: 'Sara', lastName: 'Torres', email: 'estudiante119@demo.com', enrolledAt: new Date(baseDate.getTime() - 51 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico Profesional', lastLoginAt: new Date(baseDate.getTime() - 11 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s120', firstName: 'Tomás', lastName: 'Díaz', email: 'estudiante120@demo.com', enrolledAt: new Date(baseDate.getTime() - 56 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico Profesional', lastLoginAt: new Date(baseDate.getTime() - 14 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s121', firstName: 'Ursula', lastName: 'García', email: 'estudiante121@demo.com', enrolledAt: new Date(baseDate.getTime() - 61 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico Profesional', lastLoginAt: new Date(baseDate.getTime() - 18 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s122', firstName: 'Víctor', lastName: 'Rodríguez', email: 'estudiante122@demo.com', enrolledAt: new Date(baseDate.getTime() - 66 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico Profesional', lastLoginAt: new Date(baseDate.getTime() - 22 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s123', firstName: 'Wendy', lastName: 'Martínez', email: 'estudiante123@demo.com', enrolledAt: new Date(baseDate.getTime() - 71 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico Profesional', lastLoginAt: new Date(baseDate.getTime() - 26 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s124', firstName: 'Xavier', lastName: 'López', email: 'estudiante124@demo.com', enrolledAt: new Date(baseDate.getTime() - 48 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico Profesional', lastLoginAt: new Date(baseDate.getTime() - 9 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s125', firstName: 'Yolanda', lastName: 'Sánchez', email: 'estudiante125@demo.com', enrolledAt: new Date(baseDate.getTime() - 53 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico Profesional', lastLoginAt: new Date(baseDate.getTime() - 15 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s126', firstName: 'Zoe', lastName: 'Pérez', email: 'estudiante126@demo.com', enrolledAt: new Date(baseDate.getTime() - 58 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico Profesional', lastLoginAt: new Date(baseDate.getTime() - 19 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s127', firstName: 'Alberto', lastName: 'Gómez', email: 'estudiante127@demo.com', enrolledAt: new Date(baseDate.getTime() - 63 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico Profesional', lastLoginAt: new Date(baseDate.getTime() - 27 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s128', firstName: 'Brenda', lastName: 'Fernández', email: 'estudiante128@demo.com', enrolledAt: new Date(baseDate.getTime() - 68 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico Profesional', lastLoginAt: new Date(baseDate.getTime() - 29 * 24 * 60 * 60 * 1000).toISOString() },
    { id: 'demo-s129', firstName: 'Camilo', lastName: 'Torres', email: 'estudiante129@demo.com', enrolledAt: new Date(baseDate.getTime() - 73 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico Profesional', lastLoginAt: null },
    { id: 'demo-s130', firstName: 'Diana', lastName: 'Díaz', email: 'estudiante130@demo.com', enrolledAt: new Date(baseDate.getTime() - 78 * 24 * 60 * 60 * 1000).toISOString(), className: 'Diseño Gráfico Profesional', lastLoginAt: null },
  ];
...
export function generateDemoPendingPayments(): DemoPayment[] {
  ...
  const classes = ['Programación Web Moderna', 'Matemáticas Avanzadas', 'Diseño Gráfico Profesional', 'Física Cuántica'];
