    ...
    try {
      ...
      if (pendingResult.success) {
        ...
        const mapped = pendingResult.data.map((e: any) => {
          ...
          // Add teacher info for academy role
          if (role === 'ACADEMY') {
            return {
              ...base,
      ...
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl font-semibold text-gray-900">
            {role === 'ACADEMY' ? 'Solicitudes de Inscripción' : 'Solicitudes Pendientes'}
          </h1>
          <p className="text-gray-600 text-sm mt-1">
            {role === 'ACADEMY'
              ? 'Revisa y aprueba las solicitudes de estudiantes de toda la academia'
              : 'Revisa y aprueba las solicitudes para tus clases'}
          </p>
        </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-8">
                      ...
                      <div className="border-l border-gray-200 pl-8">
                        ...
                        {role === 'ACADEMY' && enrollment.teacherName && (
