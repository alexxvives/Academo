...
export default function AcademyRevenue() {
  return (
    <DashboardLayout role="ACADEMY">
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Ingresos</h1>
          <p className="text-gray-500 mt-1">Gestión financiera y reportes de ingresos</p>
        </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-12 text-center">
          ...
          <p className="text-gray-500 max-w-md mx-auto">
            El módulo de ingresos estará disponible pronto. Podrás ver estadísticas de pagos, suscripciones y generar reportes financieros.
          </p>
