            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6 pb-6 border-b border-gray-200">
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  {academy.logoUrl ? (
                    <div className="w-11 h-11 bg-gray-50 border border-gray-200 rounded-lg p-1.5 flex items-center justify-center flex-shrink-0">
                      <img src={`/api/storage/serve/${academy.logoUrl}`} alt="Logo" className="w-full h-full object-contain" />
                    </div>
                  ) : (
                    <div className="w-11 h-11 bg-gray-100 border border-gray-300 border-dashed rounded-lg flex items-center justify-center flex-shrink-0">
                      <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
